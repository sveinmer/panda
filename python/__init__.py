...
class Panda:
  ...
  # C3 F4-revive: restore SUPPORTED_DEVICES + put DOS back in DEPRECATED.
  # MagZu's pandad.py:31 reads Panda.SUPPORTED_DEVICES; absence → AttributeError
  # crash-loop. Matches the 90387239 pre-F4-revive layout, with INTERNAL_DEVICES
  # unchanged from 41ba90e3 (DOS is internal for C3).
